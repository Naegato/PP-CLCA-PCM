...
export type NotificationWhereInput = {
  ...
  identifier?: Prisma.StringFilter<"Notification"> | string
...
export type NotificationScalarWhereWithAggregatesInput = {
  ...
  identifier?: Prisma.StringWithAggregatesFilter<"Notification"> | string
...
export type NotificationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"identifier" | "recipientId" | "message" | "type" | "isRead" | "createdAt", ExtArgs["result"]["notification"]>
...
export interface NotificationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const notificationWithIdentifierOnly = await prisma.notification.findMany({ select: { identifier: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Notifications and only return the `identifier`
   * const notificationWithIdentifierOnly = await prisma.notification.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Notifications and only return the `identifier`
   * const notificationWithIdentifierOnly = await prisma.notification.updateManyAndReturn({
   *   select: { identifier: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface NotificationFieldRefs {
  readonly identifier: Prisma.FieldRef<"Notification", 'String'>
