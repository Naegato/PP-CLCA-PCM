...
// @ts-nocheck 
/*
 * This file exports the `AdvisorProps` model and its related types.
 *
...
export type GetAdvisorPropsAggregateType<T extends AdvisorPropsAggregateArgs> = {
      [P in keyof T & keyof AggregateAdvisorProps]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAdvisorProps[P]>
    : Prisma.GetScalarType<T[P], AggregateAdvisorProps[P]>
}
...
type GetAdvisorPropsGroupByPayload<T extends AdvisorPropsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AdvisorPropsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AdvisorPropsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AdvisorPropsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AdvisorPropsGroupByOutputType[P]>
      }
    >
  >
...
export type AdvisorPropsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AdvisorPropsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AdvisorPropsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AdvisorProps'], meta: { name: 'AdvisorProps' } }
  /**
   ...
   * })
  **/
  count<T extends AdvisorPropsCountArgs>(
    args?: Prisma.Subset<T, AdvisorPropsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AdvisorPropsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends AdvisorPropsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, AdvisorPropsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAdvisorPropsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
